...
public class LangchainController {
    ...
    public Map<String, Object> makeIntroduce(@RequestBody Map<String, Object> data) {
        ...
        /*
         "UID":"BSgdiurJmYTfOspzWHg2zm3ETur2",
    ...
    public Map<String, Object> personalGuide(@RequestBody Map<String, Object> data) {
        ...
        Map<String, Object> guideMap = langchainService.personalGuide(data);
        Map<String, Object> temp = new HashMap<>();
        temp.put("UID", UID);
        temp.put("message", "給" + data.get("targetA") + "的戀愛指南" + data.get("messageA") + data.get("messageB"));
        temp.put("response", guideMap.get("response"));
        usageService.addUsage(apiName, temp);
        ...
        return resultMap;
         ...
         "targetA":"Ryan",
         "targetB":"Sophia",
         "messageA":"Ryan,30歲,190公分,獅子座,B型,男性,異性戀,自信大方、熱情開朗、喜歡冒險挑戰,喜歡運動、籃球、足球、音樂、唱歌,音樂老師,最喜歡的一句話是熱愛音樂並分享音樂。",
         "messageB":"Sophia,28歲,170公分,天秤座,AB型,女性,異性戀,溫和善良、理性冷靜、具有創造力,喜歡寫作、旅行、參觀藝術展覽、動物、觀察鳥類,記者,最喜歡的一句話是透過文字將觀察和感受傳達給他人。"
